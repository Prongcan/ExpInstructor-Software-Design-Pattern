...
from LLM_service.llm_factory import get_chat_client, get_embedding_client  # Refactored with Factory Method Pattern
from Strategies.retrieval_scoring import LLMCoverageCompareStrategy, EmbeddingCoverageCompareStrategy  # Refactored with Strategy Pattern
