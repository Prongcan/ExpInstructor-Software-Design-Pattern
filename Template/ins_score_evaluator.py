...
"""
    ...
    def initialize_agent(self):
        ...
        from Evaluation.Evaluation_feasibility_score.ins_model import create_custom_agent
        return create_custom_agent()
    
    def build_agent_prompt(self, idea_text: str) -> str:
        """Build feasibility score-specific agent prompt."""
        try:
            from Evaluation.Evaluation_feasibility_score.ins_model import build_agent_user_prompt
