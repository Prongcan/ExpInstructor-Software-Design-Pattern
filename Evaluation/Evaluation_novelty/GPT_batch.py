...
def process_single_item(item_data):
    ...
    try:
        ...
        novelty_evaluation = generate_novelty_evaluation(raw_idea)
...
def main():
    # Input file path
    input_file = "Evaluation/Evaluation_novelty/novelty_data/Stanford_comments_with_ideas_and_scores.json"
    
    # Output directory
    output_dir = "Evaluation/Evaluation_novelty/results/GPT"
