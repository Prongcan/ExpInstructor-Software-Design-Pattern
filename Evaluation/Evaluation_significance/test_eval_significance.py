...
def main():
    ...
    # Load data
    data_file = os.path.join(PROJECT_ROOT, 'Evaluation', 'Evaluation_significance', 'significance_data', 'significance_training_data.json')
    ...
    # Save results
    results_dir = "Evaluation/Evaluation_significance/results/Score_result"
