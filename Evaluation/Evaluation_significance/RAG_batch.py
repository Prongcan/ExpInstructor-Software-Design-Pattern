...
def init_worker():
    ...
    graph_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'result_v2', 'all_graphs_cleaned.json')
    global_retrieval_system = GraphRetrievalSystem(graph_path)
...
def main():
    ...
    # Output directory
    output_dir = "Evaluation/Evaluation_significance/results/RAG_evidence_retrieval"
