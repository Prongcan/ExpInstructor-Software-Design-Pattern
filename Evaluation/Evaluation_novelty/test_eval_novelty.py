...
from Evaluation.Evaluation_utils.eval_novelty import generate_novelty_score
...
def main():
    ...
    # Load data
    data_file = os.path.join(PROJECT_ROOT, 'Evaluation', 'Evaluation_novelty', 'novelty_data', 'novelty_training_data.json')
    ...
    # Save results
    results_dir = "Evaluation/Evaluation_novelty/results/Score_result"
