...
from Evaluation.Evaluation_utils.eval_feasibility_score import generate_feasibility_score
...
def main():
    ...
    # Load data
    data_file = os.path.join(PROJECT_ROOT, 'Evaluation', 'Evaluation_feasibility_score', 
    ...
    # Save results
    results_dir = os.path.join(PROJECT_ROOT, "Evaluation/Evaluation_feasibility_score", "results")
