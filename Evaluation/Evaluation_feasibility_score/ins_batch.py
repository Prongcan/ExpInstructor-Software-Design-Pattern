...
# -*- coding: utf-8 -*-
"""
Evaluate the feasibility score of concerns generated by Instructor model
Read gen_concerns from Evaluation.Evaluation_feasibility results, convert to text format, then score using eval_feasibility_score.py
"""
...
from ins_single import generate_feasibility_evaluation
...
def process_single_sample(args: Tuple[Dict, Dict[str, float]]) -> Tuple[str, Optional[float], Optional[float], Optional[str], Optional[str]]:
    ...
    try:
        # Use global agent (each process has its own agent instance)
        # Generate feasibility evaluation text (similar to all_comments)
        evaluation_text = generate_feasibility_evaluation(idea_text, global_agent)
...
def load_golden_scores() -> Dict[str, float]:
    ...
    """
    golden_file = os.path.join(PROJECT_ROOT, 'Evaluation', 'Evaluation_feasibility_score', 
...
def main():
    """Main function"""
    print("=" * 60)
    print("Evaluate the feasibility score of concerns generated by Instructor model")
    print("=" * 60)
    ...
    # Load input data
    input_file = os.path.join(PROJECT_ROOT, 'Evaluation', 'Evaluation_feasibility_score', 
                              'Stanford_comments_with_ideas_with_scores.json')
    ...
    # Determine number of processes (refer to Evaluation_feasibility/ins_batch.py, use smaller number of processes)
    num_processes = 10
    ...
    for i in range(0, len(valid_data), batch_size):
        ...
        # Use multiprocessing to process batch (use initializer to initialize agent for each process)
    ...
    # Save results
    results_dir = os.path.join(PROJECT_ROOT, "Evaluation/Evaluation_feasibility_score", "results", "instructor")
    ...
    with open(report_file, 'w', encoding='utf-8') as f:
        f.write("=" * 60 + "\n")
        f.write("Instructor Model Feasibility Score Evaluation Report\n")
        f.write("=" * 60 + "\n\n")
