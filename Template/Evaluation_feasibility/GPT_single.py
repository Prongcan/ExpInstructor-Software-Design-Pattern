...
def generate_concerns_for_idea(idea_text: str) -> t.Tuple[t.List[str], str]:
    ...
    Refactored with Template Method Pattern: Now uses unified GPT template.
    """
    # Refactored with Template Method Pattern: Use unified GPT evaluation template
    return generate_gpt_evaluation(idea_text, "feasibility")
...
def main() -> None:
    ...
    gen_concerns, raw_resp_idea = generate_gpt_evaluation(raw_idea, "feasibility")
