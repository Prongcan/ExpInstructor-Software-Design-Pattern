...
def generate_significance_evaluation_via_agent(agent, idea_text: str) -> str:
    ...
    """
    evaluator = InstructorEvaluationTemplate("significance")
...
def generate_significance_evaluation(idea_text: str) -> str:
    ...
    """
    return generate_agent_evaluation(idea_text, "significance")
...
def main() -> str:
    ...
    result = generate_agent_evaluation(raw_idea, "significance")
    print(result)
