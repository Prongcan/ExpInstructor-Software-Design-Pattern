...
def main():
    # Input file path
    input_file = "Evaluation/Evaluation_feasibility/feasibility_data/Stanford_comments_with_ideas_with_concerns.json"
    
    # Output directory
    output_dir = "Evaluation/Evaluation_feasibility/results/RAG_evidence_retrieval"
