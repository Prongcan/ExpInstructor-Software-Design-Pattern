...
def init_worker():
    ...
    graph_path = os.path.join(PROJECT_ROOT, 'result_v2', 'all_graphs_cleaned.json')
    # Initialize GraphRetrievalSystem with the graph file
...
def main():
    ...
    # Save results
    results_dir = os.path.join(PROJECT_ROOT, "Evaluation/Evaluation_feasibility_score", "results", "RAG_evidence_retrieval")
